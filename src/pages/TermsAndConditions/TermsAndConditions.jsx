    ...
    return (
        <div className="terms-page">
            <div className="container">
                ...
                <p className="last-updated">Last updated: April 23, 2025</p>

                <section>
                    <p>
                        For the purpose of these Terms and Conditions, the terms "we", "us", and "our" refer to
                        <strong> CollegeMap</strong>, whose registered/operational office is located at PARSHWAJYOT CHS
                        SOCIETY, Raigarh, MH, Maharashtra 410206. The terms "you", "your", "user", and "visitor" refer to
                        any natural or legal person who is visiting our website and/or agrees to purchase from us.
                    </p>
                    <p>
                ...
                <section>
                    <ul>
                        ...
                        <li>
                            ...
                            your own risk, for which we shall not be liable. It is your responsibility to ensure that any
                            products, services, or information available through our website and/or product pages meet
                        ...
                        <li>
                            ...
                            prohibited except in accordance with the copyright notice, which forms part of these terms
                            and conditions.
                        </li>
                        <li>
                            All trademarks reproduced on our website that are not the property of, or licensed to, the
                        ...
                        <li>
                            ...
                            CollegeMap’s prior written consent.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            having exceeded the preset limit mutually agreed by us with our acquiring bank.
                        </li>
                    </ul>
                </section>
            </div>
